...
const Posts = () => {
  ...
  return (
    <Layout title="Manage Posts">
      <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="relative flex-grow max-w-md">
          ...
          <input
            ...
            className="pl-10 pr-4 py-2 bg-white dark:bg-[#1a1a1a] border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-gray-100 focus:ring-[#e94235] focus:border-[#e94235] block w-full transition-colors duration-300"
            value={searchTerm}
      ...
      <div className="bg-white dark:bg-[#1a1a1a] rounded-lg shadow mb-6 p-4 transition-colors duration-300">
        <div className="flex items-center mb-4">
          <Filter className="h-5 w-5 text-gray-500 mr-2" />
          <h3 className="text-lg font-medium text-gray-700 dark:text-gray-200">Filters</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">Category</label>
            <select
              className="w-full bg-white dark:bg-[#242424] border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-gray-900 dark:text-gray-100 focus:ring-[#e94235] focus:border-[#e94235] transition-colors"
            ...
            <tbody className="bg-white dark:bg-[#1a1a1a] divide-y divide-gray-200 dark:divide-gray-800">
              {filteredPosts.length > 0 ? (
                filteredPosts.map((post) => (
                  <tr key={post.id} className="hover:bg-gray-50 dark:hover:bg-[#242424] transition-colors">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="h-10 w-10 flex-shrink-0 bg-gray-100 dark:bg-gray-800 rounded">
                          {
                            <img
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-sm text-gray-500 dark:text-gray-500 truncate max-w-xs">{post.excerpt}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
